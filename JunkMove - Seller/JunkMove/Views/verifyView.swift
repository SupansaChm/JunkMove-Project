...
struct verifyView : View {
    ...
    @State var showSellerRegister = false
    ...
    var body: some View {
        ...
        ZStack{
                    ...
                    Auth.auth().signIn(with: credential) { (res, err) in
                        ...
                        checkUser { (exists, user) in
                            ...
                            if exists {
                                ...
                                self.loading.toggle()
                                self.showSellerRegister.toggle()
            ...
            ZStack(alignment: .topLeading ) {
                ...
                .fullScreenCover(isPresented: $showSellerRegister) {
                    sellerRegister(showSellerRegister: self.$showSellerRegister)
                }
            }
        }
    }
